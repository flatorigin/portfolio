    ...
    const load = async () => {
      ...
      try {
        if (isNew) {
          ...
          if (data.estimate_type !== "framing") { navigate(`/${['drywall', 'paving', 'roofing', 'flooring'].includes(data.estimate_type) ? data.estimate_type : 'project'}-estimator/${estimateId}`, { replace: true }); return; }
