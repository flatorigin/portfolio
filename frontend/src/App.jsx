...
export default function App() {
  ...
  const isFullBleed =
    ...
    pathname.startsWith("/framing-estimator") ||
    pathname.startsWith("/drywall-estimator") ||
    ...
    pathname.startsWith("/decking-estimator") ||
    pathname.startsWith("/fencing-estimator") ||
    pathname.startsWith("/windows-estimator") ||
    pathname.startsWith("/doors-estimator") ||
    pathname.startsWith("/garage_coating-estimator") ||
    pathname === "/estimates" ||
    false;
  const hideShellNav =
    pathname === "/" ||
